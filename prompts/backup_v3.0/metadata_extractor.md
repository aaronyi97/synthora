...
{
  "key_insights": [
    "具体的、独立的知识要点1（包含数据/名称/结论，脱离上下文仍可理解）",
    "具体的知识要点2",
    "具体的知识要点3"
  ],
  ...
  "pairwise_comparisons": [
    {"model_a": "model_id_1", "model_b": "model_id_2", "winner_accuracy": "model_id_1", "winner_reasoning": "model_id_2", "brief_reason": "A引用了2024年Nature论文数据，B仅给出定性描述"},
    {"model_a": "model_id_1", "model_b": "model_id_3", "winner_accuracy": "tie", "winner_reasoning": "model_id_1", "brief_reason": "准确性相当，但A多了反驳视角的分析"}
  ]
}
```
